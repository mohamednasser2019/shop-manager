...
<link href="{{ asset('public/admin/pages/css/login-soft.css') }}" rel="stylesheet" type="text/css"/>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN THEME STYLES -->
<link href="{{ asset('public/global/css/components.css') }}" id="style_components" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="{{ asset('public/admin/layout/css/themes/default.css') }}" rel="stylesheet" type="text/css"/>
