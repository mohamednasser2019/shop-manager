...
<div class="logo">
	<a href="index.html">
	<img src="{{ asset('public/admin/layout2/img/logo-big.png') }}" alt=""/>
	</a>
</div>
<!-- END LOGO -->
	...
	<form class="login-form" action="{{ route('login') }}" method="post">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="email" autocomplete="off" placeholder="Email address" name="email" required="required" autofocus="autofocus" value="{{ old('email') }}"/>
			</div>
			       <div>
              @if ($errors->has('email'))
		...
		<div class="form-actions">
			...
			<button type="submit" value="Login" class="btn blue pull-right">
